...
import { CreateBankMachine } from '../../machines/bankAccounts/createBankMachine';
...
const BankForm = ({ goToDataTable }) => {
    ...
    const [current, send] = useMachine(CreateBankMachine);
            ...
            <Form onSubmit={handleSubmit} className="form-row">
                {!(current.matches('completedForm')) ? (
                    <>
                        ...
                        <CompletedFormLayout message={"¡El banco se ha creado correctamente!"} />
                    )}
            </Form>
        </Container>
    );
